<footer class="l-footer">
    ...
    <nav class="l-footer__nav l-footer__nav--tab">
        ...
        <div class="l-footer__nav__column l-footer__nav__column--right">
            <div class="l-footer__nav__group">
                <a class="l-footer__nav__item list-title">会社情報</a>
                <ul class="l-footer__nav__list company-info">
                    <li class="l-footer__nav__list__item"><a href="">会社概要</a></li>
    ...
    <ul class="l-footer__sns">
        ...
        <li class="l-footer__sns__item">
            <a href=""><i class="c-pop l-footer__sns__img instagram c-icon--instagram"></i></a>
        </li>
        <li class="l-footer__sns__item">
            <a href=""><i class="c-pop l-footer__sns__img facebook c-icon--facebook"></i></a>
        </li>
    </ul>
