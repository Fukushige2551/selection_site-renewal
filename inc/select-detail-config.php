                ...
                'sections' => [
                    [
                        ...
                        'text_blocks' => [
                            ...
                            '同じスーパーマーケットでも、地域によって求められるものは大きく違います。ファミリーが多い地域。高齢のお客様が多い地域。働く女性が多い地域。単身世帯が多い地域。',
                            'だから私たちは、全店一律ではなく、その地域のお客様の暮らしに合わせた売場づくりを大切にしています。',
                            '青果売場では、地元野菜や旬の野菜を積極的に取り扱い、「今美味しいもの」を提案しています。水産売場では、近海鮮魚や旬の魚を中心に、焼くだけ・煮るだけで食べられる商品提案を強化しています。食肉売場では、毎日の使いやすさを重視し、平日は時短、週末はごちそうといった生活シーンに合わせた売場づくりを行っています。',
                            'また、惣菜売場では、「今日の夕飯が決まる」ことを重視しています。仕事帰りでも、忙しい日でも、家庭で作るような温かみのあるおかずを気軽に選べる。そんな売場を目指しています。',
                        ],
                        'secondary_image' => ['src' => '画像とラベル.png', 'alt' => '売場で商品を案内するスタッフ'],
                        'secondary_text_blocks' => [
                            '私たちは、昔ながらの商店街のような温かさを大切にしています。',
                            '「今日はこれがおすすめですよ」「今が旬ですよ」「この食べ方がおいしいですよ」',
                            'そんな会話が自然に生まれるお店には、単なる安さだけではない魅力があります。',
                            '旬を知っていること。食べ方を知っていること。地域の食文化を知っていること。そして、お客様の暮らしを知っていること。',
                    ...
                    [
                        ...
                        'text_blocks' => [
                            '私たちの体は、毎日の食事からできています。どんな食材を選ぶか。どんな調味料を使うか。どんなものを毎日食べ続けるか。それは、未来の健康にもつながっています。',
                            'だからこそセレクションでは、「食べるもの」をとても大切に考えています。私たちが目指しているのは、“特別な時だけの高級食材”ではなく、毎日の暮らしの中で安心して食べ続けられる商品です。',
                            'たとえば食肉では、飼育方法や飼料に配慮した商品、必要以上の投薬を抑えた畜産物など、安心して食べられる商品選びを大切にしています。加工食品でも、必要以上の添加物に頼らず、素材本来の味を感じられる商品を積極的に取り扱っています。',
                            'また、野菜や果物でも、見た目だけではなく、味や鮮度、生産背景を重視しています。旬のものを旬の時期に食べることは、美味しさだけではなく、自然な食生活にもつながります。',
                        ],
                        'secondary_image' => ['src' => '検品するスタッフ.png', 'alt' => '入荷した野菜を検品するスタッフ'],
                        'secondary_text_blocks' => [
                            'しかし私たちは、「良い商品だから高くて当然」とは考えていません。近年、食品価格や光熱費など、暮らしを取り巻く環境は大きく変化しています。だからこそ、“良いものを毎日の価格で届けること”が大切だと考えています。',
                            '「美味しいけれど高すぎる」「安いけれど不安がある」そのどちらでもなく、品質・価格・美味しさのバランスを大切にした商品選びを行っています。',
                            '毎日食べるものだからこそ、安心して選べること。毎日使うものだからこそ、無理なく続けられること。',
                    ...
                    [
                        ...
                        'text_blocks' => [
                            '食卓には、人を笑顔にする力があります。美味しいものを食べた時。新しい味に出会った時。家族や友人と楽しい時間を過ごした時。食卓は、日々の暮らしを豊かにしてくれます。',
                            'セレクションでは、「毎日の買い物の中に、小さな楽しさや発見を届けること」を大切にしています。',
                            'そのため、一般的なスーパーには少ない、“ちょっと珍しい商品”や“専門店のような楽しさ”を感じられる商品を積極的に取り扱っています。地元でしか出回らない少量生産の商品。専門店でしか見かけないようなお酒。こだわりの調味料。季節限定の商品。地域色のある食材。輸入食品や話題の商品。',
                            '「こんな商品があったんだ」「食べてみたい」「今日はこれを試してみよう」そんな小さな発見が、毎日の買い物を少し楽しくしてくれると私たちは考えています。',
                            'また、店内や加工センターで製造する惣菜や生鮮食品にも力を入れています。',
                        ],
                        'secondary_image' => ['src' => '惣菜撮影予定.png', 'alt' => '店内で販売する惣菜'],
                        'secondary_text_blocks' => [
                            '忙しい日でも、美味しいものを手軽に食べたい。外食ほど高くなく、家庭では作りづらい料理を楽しみたい。そんなお客様の声に応えられるよう、出来立て感や素材感を大切にした商品づくりを行っています。',
                            '魚屋だからできる焼魚。肉屋だからできる肉惣菜。お酒に合うおつまみ。季節感のあるおかず。少人数でも使いやすいおかずセット。',
                            '単に「便利」なだけではなく、「また食べたい」と思っていただける味づくりを目指しています。',
                            'さらに、売場では季節感も大切にしています。春は山菜。夏は涼味やスタミナ。秋は旬の味覚。冬は鍋やごちそう。',
